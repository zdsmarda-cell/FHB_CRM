  ...
  en: {
    translation: {
      ...
      admin: {
        ...
        remindersTitle: 'Stage Reminder Rules',
        remindersDesc: 'Configure automatic activity reminders and Kanban highlights for deals inactive in a stage for a given number of days.',
        addReminder: 'Add Reminder Rule',
        editReminder: 'Edit Reminder Rule',
        runCronNow: 'Run Reminders Check Now (Test Cron)',
        runningCron: 'Checking...',
        cronTestResult: 'Test executed: Checked {{checked}} deals, sent {{sent}} emails.',
        cronError: 'Error running cron: {{error}}',
        daysCount: 'Days count',
        daysPlaceholder: 'e.g. 7',
        daysInvalidError: 'Please enter a valid number of days greater than 0.',
        action: 'Action',
        actionNone: 'No action',
        actionEmail: 'Email notification to deal user',
        color: 'Highlight Color',
        colorNone: 'None',
        colorYellow: 'Yellow',
        colorOrange: 'Orange',
        colorRed: 'Red',
        duplicateDaysError: 'A reminder rule with this number of days already exists for this stage.',
        rulesCount: 'Rules: {{count}}',
        noRulesForStage: 'No reminder rules defined for this stage.',
        afterXDays: 'After {{days}} days',
        actionLabel: 'Action: {{action}}',
        actionEmailShort: 'Send email',
        actionNoneShort: 'None',
        editRule: 'Edit rule',
      ...
      common: {
        ...
        filters: 'Filters',
        allUsers: 'All users',
        reminderColorFilter: 'Reminder Color',
  ...
  cs: {
    translation: {
      ...
      admin: {
        ...
        remindersTab: 'Upozornění (Reminder)',
        remindersTitle: 'Pravidla upozornění pro stav příležitostí',
        remindersDesc: 'Definujte dobu neaktivity v jednotlivých stavech, po které dojde k upozornění nebo zvýraznění karty v Kanbanu.',
        addReminder: 'Přidat pravidlo upozornění',
        editReminder: 'Upravit pravidlo upozornění',
        runCronNow: 'Spustit kontrolu upozornění (Test Cronu)',
        runningCron: 'Probíhá kontrola...',
        cronTestResult: 'Test spuštěn: Zkontrolováno {{checked}} příležitostí, odesláno {{sent}} e-mailů.',
        cronError: 'Chyba při spuštění cronu: {{error}}',
        daysCount: 'Počet dní (celé číslo)',
        daysPlaceholder: 'Např. 7',
        daysInvalidError: 'Zadejte platné celé číslo dní větší než 0.',
        action: 'Akce',
        actionNone: 'Žádná akce',
        actionEmail: 'E-mailové upozornění uživateli příležitosti',
        color: 'Barva zvýraznění (Rámeček v Kanbanu)',
        colorNone: 'Žádná',
        colorYellow: 'Žlutá',
        colorOrange: 'Oranžová',
        colorRed: 'Červená',
        duplicateDaysError: 'Pro tento stav již existuje pravidlo se stejným počtem dní.',
        rulesCount: 'Pravidel: {{count}}',
        noRulesForStage: 'Pro tento stav nebyly definovány žádné připomínky.',
        afterXDays: 'Po {{days}} dnech',
        actionLabel: 'Akce: {{action}}',
        actionEmailShort: 'Odeslat e-mail',
        actionNoneShort: 'Žádná',
      ...
      common: {
        ...
        reminderColorFilter: 'Barva upozornění',
        allColors: 'Všechny barvy',
